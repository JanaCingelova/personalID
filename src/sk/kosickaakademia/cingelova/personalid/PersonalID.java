package sk.kosickaakademia.cingelova.personalid;
...
public class PersonalID {
    public boolean checkId(String id) {
        ...
        if ((id.charAt(3)=='4'|| id.charAt(3)!='6'|| id.charAt(3)!='9') && id.charAt(4)!='3' && id.charAt(5)!='1')
            return false;
        if ((id.charAt(2)!='1'|| id.charAt(2)!='6') && id.charAt(3)!='1' && id.charAt(4)!='3' && id.charAt(5)!='1')
            return false;
        if (year%4==0 && id.charAt(4)=='2' && id.charAt(5)!='9')
            return false;
